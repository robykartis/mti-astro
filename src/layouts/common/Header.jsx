...
const Header = () => {
    const [theme, setTheme] = useState(
      ...
      const themeToggleIconClassName = theme === 'dark' ? 'hidden' : '';
      const mobileMenuIconClassName = mobileMenuVisible ? '' : 'hidden';
  return (
    <header className="sticky top-0 z-50 backdrop-blur-xl bg-white/60  ">
  <nav className=" px-4 lg:px-6 py-2.5 dark:bg-gray-800/95 dark:backdrop:blur-sm border-b">
    <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
      <a href="https://flowbite.com" className="flex items-center">
        <img src="assets/logo/logo.png" className="mr-3 h-6 sm:h-9" alt="Flowbite Logo" />
        <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white">MITUNI</span>
      </a>
